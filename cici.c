#include <stdio.h>
#include <stdbool.h>
#include "libs/cici_def.h"
#include "libs/cici_utils.h"
...
int checkBuiltInCommands()
{
        ...
        if (strcmp("cls", commandArgv[0]) == 0)
        {
                system("clear");
                return 1;
        }
        if (strcmp("shell-release", commandArgv[0]) == 0)
        {
                printf("├─");
                printf(ANSI_COLOR_BLUE "cici" RESET_COLOR);
                printf("\n└─version 1.0\n");
                return 1;
        }
        if (strcmp("kernel", commandArgv[0]) == 0)
        {
                system("uname -r");
                return 1;
        }
        if (strcmp("creator_page", commandArgv[0]) == 0) {
                kreatorPage();
        }
        if (strcmp("about-shell", commandArgv[0]) == 0)
        {
                aboutShell();
                return 1;
        }
        if (strcmp("dev", commandArgv[0]) == 0)
        {
                dev();
                return 1;
        }
        if (strcmp("color_a", commandArgv[0]) == 0)
        {
                printf(ANSI_COLOR_GREEN);
                return 1;
        }
        if (strcmp("color_d", commandArgv[0]) == 0)
        {
                printf(ANSI_COLOR_PURPLE);
                return 1;
        }
        if (strcmp("color", commandArgv[0]) == 0)
        {
                printf(RESET_COLOR);
                return 1;
        }
